...
<div class="container">
    <div class="col-md-3" style="position: absolute ;margin-left:-120px; margin-top: 3px;width:30%;">
        ...
        <button class="btn btn-primary" style="width:50%; height:100%; height:70px; margin-top: 10px;">
          Procurement Status
        </button>
    ...
    <div class="row">
        <div class="col-md-12 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading" style="text-align: center; background-color: #F0F7D4;color:white">Records</div>
                ...
                <div class="panel-body">
                    ...
                    <div class="btn btn-group">
                        ...
                        <a href="{{route('getExport')}}" style="margin-left: 5px" class="btn btn-primary">Export</a>
                        </div>
